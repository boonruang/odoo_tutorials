...
class OrderFormController extends FormController {
    ...
    async printLabel() {
        const serverResult = await this.orm.call(this.model.root.resModel,"print_label", [this.model.root.resId]);
...
OrderFormController.template = "academy_tshirt.OrderFormView";
